...
$NEWS_VIEW_TEMPLATE['default']['item'] = '
	...
	<div class="parallax">
        <div class="parallax-image">
            <img src="{NEWSIMAGE: type=src}" style="top: 0px;">
        </div>
    </div>
	<h1 class="title title-blog">{NEWS_TITLE}</h1>
	...
	<div class="options hidden-print ">
		<div class="btn-group">{NEWSCOMMENTLINK: glyph=comments&class=btn social-share}{PRINTICON: class=btn social-share}
		{ADMINOPTIONS: class=btn social-share}{SOCIALSHARE}</div>
	</div>
	<br>
	<br>';
										/*
