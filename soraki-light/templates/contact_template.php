...
$CONTACT_TEMPLATE['menu'] =  '
 ...
 ';
	...
	$CONTACT_WRAPPER['form']['CONTACT_EMAIL_COPY'] 			= "<div class='control-group form-group checkbox'><label for='email_copy'>{---}".LANCONTACT_07."</label></div>";
	...
	{CONTACT_PERSON}
	<div class='form-group'><label for='contactName'>".LANCONTACT_03."</label>
		{CONTACT_NAME}
	</div>
	<div class='form-group'><label for='contactEmail'>".LANCONTACT_04."</label>
		{CONTACT_EMAIL}
	</div>
	<div class='form-group'><label for='contactSubject'>".LANCONTACT_05."</label>
		{CONTACT_SUBJECT}
	</div>

		{CONTACT_EMAIL_COPY}

	<div class='form-group'><label for='contactBody'>".LANCONTACT_06."</label>
		{CONTACT_BODY}
	</div>
	...
	{CONTACT_SUBMIT_BUTTON: class=btn btn-info btn-fill}
	</div>
	...
	'<h2 class="section-title">'.LAN_SORAKI_THEME_00.'</h2> 
	 <div class="row">
	 <div class="col-md-6"><p>'.LAN_SORAKI_THEME_01.'<br><br></p>'.
	 $contact_form.
	'</div>
