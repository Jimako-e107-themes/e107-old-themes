...
if(!defined($COPPA_TEMPLATE))
{
	...
	<br />
	<div class='text-center'><b>".LAN_SIGNUP_17."</b>
		{SIGNUP_COPPA_FORM: class=btn btn-info btn-fill}
	</div>";
}
...
if(!defined($SIGNUP_BODY))
{
	$SIGNUP_BODY = "
	{SIGNUP_XUP}
	<div id='default' class='table-responsive'>
		{SIGNUP_XUP_ACTION}
		<table class='table fborder' style='".USER_WIDTH."'>
			...
			<tr style='vertical-align:top'>
				<td class='forumheader' colspan='2'  style='text-align:center'>
					<input class='btn btn-info btn-fill' type='submit' name='register' value=\"".LAN_SIGNUP_79."\" />
					<br />
				</td>
			</tr>
		</table>
