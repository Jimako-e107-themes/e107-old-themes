...
<a class="'.$link_settings['main']['linkclass_sub_hilite'].'" '.$link_settings['main']['dropdown_on'].' data-target="#" href="{LINK_URL}" title="{LINK_NAME} {LINK_DESCRIPTION}">
		 item_submenu_active{LINK_ICON}{LINK_NAME}'.$link_settings['main']['linkcaret'].'
		</a>
	   {ALT_LINK_SUB}
'.$link_settings['main']['linkend'];
...
$NAVIGATION_TEMPLATE["footer"]["start"] 				= '<ul class="list-inline footer-links float-md-right mb-0">';
