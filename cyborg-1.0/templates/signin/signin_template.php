...
$SIGNIN_WRAPPER['signin']['SIGNIN_SIGNUP_HREF'] = $link_settings['alt']['linkstart'].'<a class="nav-link" href="{---}">{LAN=LAN_LOGINMENU_3}</a>'.$link_settings['alt']['linkend']; 

$SIGNIN_TEMPLATE['signin'] = $link_settings['alt']['prelink'].'
 
				{SIGNIN_SIGNUP_HREF}
				'.$link_settings['alt']['linkdivider'].'
				<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" data-toggle="dropdown">{LAN=LAN_LOGINMENU_51} '.$link_settings['alt']['linkcaret'].'</a>
...
$SIGNIN_TEMPLATE['signout'] = '
		...
		<ul class="navbar-nav navbar-right">
			{SIGNIN_PM_NAV}
			<li class="dropdown dropdown-avatar"><a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-toggle="dropdown">{USER_AVATAR: w=30&h=30&crop=1&shape=circle} {SIGNIN_USERNAME} '.$link_settings['alt']['linkcaret'].'</a>
