...
$GALLERY_TEMPLATE['list']['caption'] = LAN_PLUGIN_GALLERY_TITLE . ' -   {GALLERY_CAT_TITLE}' ;
...
<div class="col-md-3">
	<h3 class="text-center">{GALLERY_CAPTION}</h3>
	<article>
		<a class="gallery" href="{GALLERY_THUMB: w=0&h=0&thumburl=1}" data-gal="prettyPhoto[pp_gal]" >
		<img src="{GALLERY_THUMB:  w=0&h=0&thumbsrc=1}" alt="{GALLERY_CAPTION: text=1}"/>
		</a>
	</article>
</div> ';
...
<div class="col-md-3">
	<h3 class="text-center">{GALLERY_CAT_TITLE}</h3>
	<article>
		<a class="gallery" href="{GALLERY_CAT_URL}">
		<img src="{GALLERY_CAT_THUMB:  w=0&h=0&thumbsrc=1}" alt="{GALLERY_CAT_TITLE: text=1}"/>
		</a>
	</article>
</div> ';
