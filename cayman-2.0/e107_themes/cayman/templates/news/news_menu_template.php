...
$NEWS_MENU_TEMPLATE['archive']['start']       = '<div class="news-archive-menu"><ul class="list-group news-archive-menu">';
$NEWS_MENU_TEMPLATE['archive']['end']         = '</ul></div>';

$NEWS_MENU_TEMPLATE['archive']['year_start']        = "<li class='list-group-item'  style='padding-left: 0px; padding-right: 0px;  ' >
												<a class='e-expandit {EXPANDOPEN}' href='#{YEAR_ID}' style='display:block'>{YEAR_NAME}</a>
												<ul id='{YEAR_ID}' class='list-group news-archive-menu-months' style='display:{YEAR_DISPLAY}; margin-bottom: 1px;'>
												";
$NEWS_MENU_TEMPLATE['archive']['year_end']        = '</ul></li>';

$NEWS_MENU_TEMPLATE['archive']['month_start']        = "<li class='list-group-item' style='padding-left: 0px; padding-right: 0px; border: none;'>
													 <a class='e-expandit' href='#{MONTH_ID}'>{MONTH_NAME}</a>
													 <ul id='{MONTH_ID}' class='list-group news-archive-menu-items' style='display:none; margin-bottom: 1px;'>
													 ";
$NEWS_MENU_TEMPLATE['archive']['month_end']        = '</ul></li>';

$NEWS_MENU_TEMPLATE['archive']['item']        = "<li class='list-group-item' style='padding-left: 0px; padding-right: 0px; border: none;'><a href='{ITEM_URL}'>{ITEM_TITLE}</a></li>\n";
