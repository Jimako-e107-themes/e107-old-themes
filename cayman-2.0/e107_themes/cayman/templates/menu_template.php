...
#### Additional control over image thumbnailing is possible via SETIMAGE e.g. {SETIMAGE: w=200&h=150&crop=1}
	...
	$MENU_TEMPLATE['navigation']['start']  = '<ul class="nav nav-stacked" id="sidebar" style="margin-top:20px;"><li class="text-center menutitle">LIST OF CONTENT</li>';
	$MENU_TEMPLATE['navigation']['body']   = '<li><a href="#{CPAGEANCHOR}">{CPAGETITLE}</a></li>';
	$MENU_TEMPLATE['navigation']['end']    = '</ul>';