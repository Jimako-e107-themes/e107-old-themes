...
$NEXTPREV_TEMPLATE['bootstrap_start']			= '<ul class="list-unstyled pagination text-center">';
...
$NEXTPREV_TEMPLATE['bootstrap_nav_prev'] 		= '<li><a class="prev" href="{url}" title="{url_label}"><i class="fa fa-long-arrow-left"></i></a></a></li>';
...
$NEXTPREV_TEMPLATE['bootstrap_item_current'] 	= '<li class="active"><a class="page-link" href="#" onclick="return false;" title="{url_label}">{label}</a></li>';
