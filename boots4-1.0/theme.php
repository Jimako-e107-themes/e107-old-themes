...
e107::lan('theme');
    ...
    class theme implements e_theme_render
    {
		...
		//	e107::js('footer', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyARdVcREeBK44lIWnv5-iPijKqvlSAVwbw&callback=initMap', 'jquery');
        ...
        {
			e107::css('url', "https://fonts.googleapis.com/css?family=Raleway:100,300,400,500,700&display=swap&subset=latin-ext");
			e107::css('url', "https://fonts.googleapis.com/css?family=Source+Sans+Pro&display=swap&subset=latin-ext");
        }
            ...
            switch ($style) {
              ...
              case "default": 
				if (!empty($caption)) {
						...
						<h2 class="fs-2 fs-sm-3"> ' . $caption . '</h2>
						<hr class="hr-ornate" />
					  </div>';
