...
$HERO_TEMPLATE['default']['start'] 	    = '<div class="carousel-item item bg-gradient-info  {HERO_SLIDE_ACTIVE}" style="background-image:{HERO_BGIMAGE}" >
						                  <div class="container">
						                  
						                  <div class="carousel-caption">
						                    <div class="hero-text-container">
						                      <header  class="hero-title animated slideInLeft animation-delay-5 page-header  bg-gradient-dark">
						                        <h1 class="animated fadeInLeft animation-delay-10 font-smoothing text-white">{HERO_TITLE: enwrap=strong}</h1>
						                        <h2 class="animated fadeInLeft animation-delay-12 text-white">{HERO_DESCRIPTION: enwrap=span&class=text-bold}</h2>
						                      </header>
						          				<div class="row">
							                      <div class="col-md-6">
...
$HERO_TEMPLATE['default']['end'] 	            = '</ul>
	                                            ...
	                                            <div class="col-md-6 hero-media-container">
		                                            ...
		                                            {HERO_MEDIA: class=img-responsive img-fluid d-block w-75}
		                                            </div>
	                                            </div>
 											</div>
 											<div class="hero-buttons py-3 text-right text-end">
					                          <a href="{HERO_BUTTON1_URL}" class="btn-{HERO_BUTTON1_CLASS} active lg-round text-uppercase animated fadeInRight animation-delay-28">
...
$HERO_TEMPLATE['slider']['header'] 	= ' {SETIMAGE: w=400&h=400}
<div class="main-slider">
 ';


$HERO_TEMPLATE['slider']['footer'] 	= '</div>';


$HERO_TEMPLATE['slider']['start'] 	    = '
<div class="slide bg-full" style="background-image:{HERO_BGIMAGE}">
	<div class="holder">
		<div class="b-logo">
			{HERO_MEDIA: class=img-responsive}
		</div>
		<a href="{HERO_BUTTON1_URL}" class="btn-primary active lg-round text-uppercase">{HERO_BUTTON1_LABEL}</a>
	</div>
</div>
';

$HERO_TEMPLATE['slider']['end'] 	            = '';



$HERO_TEMPLATE['slider']['item'] 	    = 
'
