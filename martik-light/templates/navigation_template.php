...
// big footer, footer links in column
// if you need caption, use shortcode menu with {NAVIGATION: type=xxx&layout=footer-column}
$NAVIGATION_TEMPLATE["footer-column"]["start"] 				= "<nav><ul>\n";
...
$NAVIGATION_TEMPLATE["footer-column"]["item_submenu"] 			=  '{LINK_SUB}';
$NAVIGATION_TEMPLATE["footer-column"]["end"] 					= "</ul></nav>\n";
$NAVIGATION_TEMPLATE["footer-column"]["submenu_start"] 		= "";
$NAVIGATION_TEMPLATE["footer-column"]["submenu_item"]			= $NAVIGATION_TEMPLATE["footer-column"]["item"] ;
$NAVIGATION_TEMPLATE["footer-column"]["submenu_loweritem"] 	= $NAVIGATION_TEMPLATE["footer-column"]["item"] ;
$NAVIGATION_TEMPLATE["footer-column"]["submenu_item_active"] 	= $NAVIGATION_TEMPLATE["footer-column"]["item_active"] ;
